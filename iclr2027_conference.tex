...
\textbf{Governance Layer.}\quad The governance layer hosts the collaboration protocol and validates each proposed handoff against the current protocol state. It records both accepted and rejected events in an trace that supplies the evidence for later protocol evolution.
