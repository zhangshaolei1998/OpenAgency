...
\begin{figure}[t]
\centering
\includegraphics[width=0.98\linewidth]{figures/single_vs_multi.pdf}
...
\caption{Three nested evolving spaces under one initialization. The fixed-count arm holds the agent count $|\mathcal{N}|$, and the division-only arm freezes the whole graph.}
\label{fig:evo_space}
\end{wrapfigure}
