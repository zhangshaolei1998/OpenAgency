...
LAYOUTS = {
    ...
    "MARBLE": {
        ...
        "v4": {"nodes": {"Generator": N(0.13, 0.65), "Critic": N(0.42, 0.65),
                          "Amplifier": N(0.72, 0.85), "Reviser": N(0.72, 0.45)},
               "edges": [("Generator","Critic","solid"),("Critic","Amplifier","solid"),
                         ("Amplifier","Reviser","solid"),("Critic","Generator","dashed")],
               "new_nodes": ["Amplifier"],
               "new_edges": [("Critic","Amplifier","solid"),("Amplifier","Reviser","solid")],
               "title": "v4: + innov amplifier"},
    },
    "AutomationBench": {
        ...
        "v3": {"nodes": {"Solver": N(0.50, 0.65)},
               "edges": [("Solver","Solver","dashed")],
               "new_nodes": [], "new_edges": [],
               "phases": ["Execute", "Enumerate", "Verify"],
               "new_phases": ["Enumerate"],
               "title": "v3: + req enumeration"},
        "v4": {"nodes": {"Solver": N(0.50, 0.65)},
               "edges": [("Solver","Solver","dashed")],
               "new_nodes": [], "new_edges": [],
               "phases": ["Execute", "Enumerate", "WordMatch"],
...
EDITS = {
    ...
    "MARBLE": {
        ...
        "v4": [("S", "innovation amplifier", None)]},
    "AutomationBench": {
        "v1": [], "v2": [("S", "collapse to one solver", None)],
        "v3": [("S", "enumerate phase", None)],
